...
{
    if(toggleAttach)model->setData(idx,QVariant(),ZListModel::DisplayType);
...
{
    if(toggleAttach)model->setData(index,QVariant(),ZListModel::DisplayType);
